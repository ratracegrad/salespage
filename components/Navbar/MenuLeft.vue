    ...
    <div class="relative flex flex-col px-8 mx-auto md:items-center md:justify-between md:flex-row">
      <div class="flex flex-row items-center justify-between py-6 w-full">
        <div class="flex items-center">
          ...
          <ul
            :class="{ 'transform md:transform-none scale-y-0': !showMenu, 'h-full': showMenu }"
            class="h-0 md:h-auto hidden lg:flex flex-col flex-grow md:items-center pb-4 md:pb-0 md:flex md:justify-end md:flex-row origin-top duration-300"
          >
            <ButtonsNavbarMenu />
          </ul>
        </div>
      ...
      <ul
        :class="{ 'transform md:transform-none scale-y-0': !showMenu, 'h-full': showMenu }"
        class="h-0 flex flex-col flex-grow pb-4 md:hidden origin-top duration-300"
      >
        <ButtonsNavbarMenu />
        <ButtonsLogin />
      </ul>
