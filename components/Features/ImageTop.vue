<template>
  ...
  >
    <img
      class="w-full aspect-video mx-auto object-cover rounded-xl"
    ...
    <div class="mt-5 lg:mt-16 grid lg:grid-cols-3 gap-8 lg:gap-12">
      <div class="lg:col-span-1">
        <h2 class="font-bold text-2xl md:text-3xl">
          {{ $t('features.bylineTitle') }}
        </h2>
        <p class="mt-2 md:mt-4">
          {{ $t('features.bylineDescription') }}
        </p>
      </div>
      ...
      <div class="lg:col-span-2">
        <div class="grid sm:grid-cols-2 gap-8 md:gap-12">
          ...
          >
            <Icon
              :name="feature.icon"
              class="flex-shrink-0 mt-1 size-8 text-featureLightText dark:text-featureDarkText"
            />
            <div class="grow">
