...
<template>
  ...
  >
    ...
    <div
      ...
      :key="plan.priceId"
      class="mx-auto mt-16 max-w-2xl items-stretch rounded-3xl bg-white ring-1 ring-gray-200 lg:mx-0 sm:mt-20 lg:max-w-none lg:flex"
    >
      <div class="p-8 lg:flex-auto sm:p-10">
        ...
        <ul
          role="list"
          class="grid grid-cols-1 mt-8 gap-4 text-gray-600 sm:grid-cols-2 sm:gap-6"
        >
          <li
